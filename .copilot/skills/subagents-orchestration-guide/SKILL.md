...
# Sub-agents Practical Guide - Orchestration Guidelines for GitHub Copilot (Me)

This document provides practical behavioral guidelines for me (GitHub Copilot) to efficiently process tasks by utilizing subagents.
...
**Important**: Subagents cannot directly call other subagents. When coordinating multiple subagents, the main AI (GitHub Copilot) operates as the orchestrator.
