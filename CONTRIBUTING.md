...
Report bugs at <https://github.com/fpgmaas/agentic-uv/issues
...
The best way to send feedback is to file an issue at <https://github.com/fpgmaas/agentic-uv/issues.
...
Ready to contribute? Here\'s how to set up `agentic-uv` for local development.
Please note this documentation assumes you already have `uv` and `git` installed and ready to go.

1. Fork the `agentic-uv` repo on GitHub.

2. Clone your fork locally:

```bash
cd <directory_in_which_repo_should_be_created
git clone git@github.com:YOUR_NAME/agentic-uv.git
```
